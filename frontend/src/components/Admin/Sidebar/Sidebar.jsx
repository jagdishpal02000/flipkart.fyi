...
const Sidebar = ({ activeTab, setToggleSidebar }) => {
    ...
    return (
        <aside style={{marginRight:"60px"}} className="sidebar z-10 sm:z-0 block min-h-screen fixed left-0 pb-14 max-h-screen w-3/4 sm:w-1/5 bg-gray-800 text-white overflow-x-hidden border-r">
